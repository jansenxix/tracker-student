<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left"
     style="width:200px; background-color: #3a3a3a; color: white" id="mySidebar">
    <button class="w3-bar-item w3-button w3-large w3-hide-large" onclick="w3_close()">Close &times;</button>
    <img src="/image/logo.jpg" style="width: 100%; margin-bottom: 20px">
    <a href="/dashboard" style="padding: 10px !important;"
       class="text-decoration-none px-3 py-2 d-block w3-bar-item w3-button" data-href="dashboard"><i>
    ...
    <a href="/studentlist" style="padding: 10px !important;"
       class="text-decoration-none px-3 py-2 d-block w3-bar-item w3-button" data-href="studentlist">
                <span><i class="fal fa-comment"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="currentColor" class="bi bi-backpack4" viewBox="0 0 16 16">
                  <path
                ...
                </svg></i> Student List</span>
        <a href="/registered-student" style="padding: 10px !important;"
           class="text-decoration-none px-3 py-2 d-block w3-bar-item w3-button" data-href="studentlist">
                <span><i class="fal fa-comment"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                     fill="currentColor" class="bi bi-backpack4" viewBox="0 0 16 16">
                  <path
                  ...
                  <path
                      d="M8 0a2 2 0 0 0-2 2H3.5a2 2 0 0 0-2 2v1c0 .52.198.993.523 1.349A.5.5 0 0 0 2 6.5V14a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V6.5a.5.5 0 0 0-.023-.151c.325-.356.523-.83.523-1.349V4a2 2 0 0 0-2-2H10a2 2 0 0 0-2-2m0 1a1 1 0 0 0-1 1h2a1 1 0 0 0-1-1M3 14V6.937q.24.062.5.063h4v.5a.5.5 0 0 0 1 0V7h4q.26 0 .5-.063V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1m9.5-11a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-9a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z"/>
                </svg></i> Registered Student</span>
        <a href="/course" style="padding: 10px !important;"
           class="text-decoration-none px-3 py-2 d-block w3-bar-item w3-button" data-href="course">
          <span><i class="fal fa-comment"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="w3-dropdown-hover">
        ...
        <div class="w3-dropdown-content w3-bar-block" style="background-color: #3a3a3a; color: white">
            <a class="w3-bar-item w3-button" href="/profile">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <a class="w3-bar-item w3-button" href="/logout">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<div class="w3-dropdown-hover" id="reports">
    <button class="w3-button w3-bar-item" >
    ...
    <div class="w3-dropdown-content w3-bar-block" style="background-color: #3a3a3a; color: white">
    <a  class="w3-bar-item w3-button" href="/respondent"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
        <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002-.014.002zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4"/>
      </svg> Profile Respondents</a>

    <a  class="w3-bar-item w3-button" href="/employment"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-dash-fill" viewBox="0 0 16 16">
      ...
      </svg> Employment Status</a>
    <a  class="w3-bar-item w3-button" href="/job"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
    ...
    <a  class="w3-bar-item w3-button" href="/useful "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-open-fill" viewBox="0 0 16 16">
