...
<div class="container" style="padding-bottom: 10px">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div style="padding-left: 10px">
                        ...
                        <table border="1">
                            ...
                            <tr>
                                <td style="padding: 10px"><input type="text"  name="a[name]" placeholder="Enter name:" value="{{ $student->data->a->name ?? '' }}" disabled></td>

                                <td><input type="text"  name="a[address]" placeholder="Enter Address:" value="{{ $student->data->a->address ?? '' }}" disabled></td>

                                <td><input type="text"  name="a[email]" placeholder="Enter email:" value="{{ $student->data->a->email ?? '' }}" disabled></td>


                                <td><input type="text"  name="a[phone_number]" placeholder="Enter contact number:" value="{{ $student->data->a->phone_number ?? '' }}" disabled></td>


                                <td><input type="text" name="a[contact_number]" placeholder="Enter mobile number:" value="{{ $student->data->a->contact_number ?? '' }}" disabled></td>
                            </tr>
                        </table>
                        <br> <br>
                        <table>
                            ...
                            <fieldset>
                                ...
                                <tr>
                                    <div>
                                        <td><input type="radio" id="Single" name="a[status]" value="single" {{$student->data->a->status == 'single' ? 'checked' : '' }} disabled /></td>
                                        <td><label for="Single">Single</label></td>

                                        <td><input type="radio" id="Married" name="a[status]" value="married" {{$student->data->a->status == 'married' ? 'checked' : '' }} disabled /></td>
                                        <td><label for="horns">Married</label></td>
                                    </div>


                                    <div>
                                        <td><input type="radio" id="Separated" name="a[status]" value="Separated" {{$student->data->a->status == 'Separated' ? 'checked' : '' }} disabled/></td>
                                        <td><label for="Separated">Separated</label></td>

                                        <td><input type="radio" id="sparent" name="a[status]" value="Single Parent" {{$student->data->a->status == 'Single Parent' ? 'checked' : '' }} disabled/></td>
                                        <td><label for="sparent">Single Parent</label></td>
                                    </div>


                                    <div>
                                        <td><input type="radio" id="widow" name="a[status]" value="widow" {{$student->data->a->status == 'widow' ? 'checked' : '' }} disabled/></td>
                        ...
                        <table class="gender" id="gender" border="1" style="padding-bottom: 10px">
                            <fieldset>
                                ...
                                <tr>
                                    <div>
                                        <td><input type="radio" id="male" name="a[sex]" value="male" {{$student->data->a->sex == 'male' ? 'checked' : '' }} disabled/></td>
                        ...
                        <div id="bday">
                            ...
                            <input style="width:400px;  margin-left:27px;" type="date" id="bday" name="a[bday]" value="{{$student->data->a->bday ?? '' }}" disabled/>
                        </div>
                        <br>
                    ...
                    <table border="1">
                        ...
                        <tr>
                            <td style="padding: 10px"><input type="text" id="province" name="a[province]" placeholder="Enter province"
                                       style="width: 400px; margin-left -20px;" value="{{$student->data->a->province ?? '' }}" disabled></td>
                        </tr>
                ...
                <div style="border=1;">
                    <table class="gender" id="gender" style="margin-left: 10px">
                        <fieldset>
                            ...
                            <tr>
                                <div>
                                    <td><input type="radio" id="city" name="a[location_residense]" value="city" {{$student->data->a->location_residense == 'city' ? 'checked' : '' }} disabled/></td>
                                    <td><label for="Single">CITY</label></td>
                            </tr>
                </div>

                <div>
                    <td><input type="radio" id="municipality" name="a[location_residense]" value="municipality" {{$student->data->a->location_residense == 'municipality' ? 'checked' : '' }} disabled/></td>
    ...
    <div class="border border-secondary" style="margin-left:">
        <div class="card card-outline card-primary">
            ...
            <div class="container">
                ...
                <table border="1" style="border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        <td style="padding: 10px"><input type="text" name="b[degree]" placeholder="Enter degree" value="{{$student->data->b->degree ?? '' }}" disabled></td>
                        <td><input type="text" name="b[university]" placeholder="College or University" value="{{$student->data->b->university ?? '' }}" disabled></td>
                        <td><input type="text" name="b[year]" placeholder="Year Graduated" value="{{$student->data->b->year ?? '' }}" disabled></td>
                        <td><input type="text" name="b[honor]" placeholder="Honor or Award" value="{{$student->data->b->honor ?? '' }}" disabled></td>
                ...
                <table border="1">
                    ...
                    <tbody>
                    <tr>
                        <td style="padding: 10px"><input type="text" name="b[institution_code]" placeholder="Enter Institution Code" value="{{$student->data->b->institution_code ?? '' }}" disabled></td>
                        <td><input type="text" name="b[control_code]" placeholder="Enter Control code " value="{{$student->data->b->control_code ?? '' }}" disabled></td>
                        <td><input type="text" name="b[name_examination]" placeholder="Name of Examination" value="{{$student->data->b->name_examination ?? '' }}" disabled></td>
                        <td><input type="date" name="b[date_taken]" placeholder="Enter Date Taken " value="{{$student->data->b->date_taken ?? '' }}" disabled></td>
                        <td><input type="text" name="b[rating]" placeholder="Enter Rating " value="{{$student->data->b->rating ?? '' }}" disabled></td>
                    </tr>
                    </tbody>
                </table>
            ...
            <table border="1">
                ...
                <tr>
                    <td style="padding: 10px"><input type="text" name="b[trainingTitle]" placeholder="Enter Title of Training or Advance Study" value="{{$student->data->b->trainingTitle ?? '' }}" disabled>
                    </td>
                    <td><input type="text" name="b[trainingDuration]" placeholder="Enter Duration and Credits Earned" value="{{$student->data->b->trainingDuration ?? '' }}" disabled></td>
                    <td><input type="text" name="b[trainingName]" placeholder="Enter Name of Training" value="{{$student->data->b->trainingName ?? '' }}" disabled></td>
                    <td><input type="text" name="b[trainingInstitution]" placeholder="Enter Institution/College/University" value="{{$student->data->b->trainingInstitution ?? '' }}" disabled></td>
                </tr>
            </table>
            <h4><b> &nbsp;</b></h4> <br>
        </div>
        ...
        <div class="container">
            ...
            <table border="1">
                ...
                <tr>
                    <td style="padding: 10px"><input type="text" name="c[trainingTitle]" placeholder="Enter Title of Training or Advance Study" value="{{$student->data->c->trainingTitle ?? '' }}" disabled>
                    </td>
                    <td><input type="text" name="c[trainingDuration]" placeholder="Enter Duration and Credits Earned:" value="{{$student->data->c->trainingDuration ?? '' }}" disabled>
                    </td>
                    <td><input type="text" name="c[trainingName]"
                               placeholder="Enter Name of Training Institution/College/University" value="{{$student->data->c->trainingName ?? '' }}" disabled></td>
        ...
        <table>
            <div id="region" class="region">
                <div>
                    ...
                    <label><input type="checkbox" name="d[reason_no_work_op1]" {{ isset($student->data->d->reason_no_work_op1) ? 'checked' : '' }} disabled> Advance or further study</label><br>
                    <label><input type="checkbox" name="d[reason_no_work_op2]" {{ isset($student->data->d->reason_no_work_op2) ? 'checked' : '' }} disabled> Family concern and decided not to find a job</label><br>
                    <label><input type="checkbox" name="d[reason_no_work_op3]" {{ isset($student->data->d->reason_no_work_op3) ? 'checked' : '' }} disabled> Health-related reason(s)</label><br>
                    <label><input type="checkbox" name="d[reason_no_work_op4]" {{ isset($student->data->d->reason_no_work_op4) ? 'checked' : '' }} disabled> Lack of work experience</label><br>
                ...
                <div>
                    <br><br><br>
                    <br>
                    <label><input type="checkbox" name="d[reason_no_work_op5]" {{ isset($student->data->d->reason_no_work_op5) ? 'checked' : '' }} disabled> No job opportunity</label><br>
                    <label><input type="checkbox" name="d[reason_no_work_op6]" {{ isset($student->data->d->reason_no_work_op6) ? 'checked' : '' }} disabled> Did not look for a job</label><br>
                    <label><input type="checkbox" name="d[reason_no_work_op7]" {{ isset($student->data->d->reason_no_work_op7) ? 'checked' : '' }} disabled> Other reason(s), please specify</label><br>
    ...
    <div>
        &nbsp;&nbsp; <label for="">If self-employed, what skills acquired in college were you able to apply in your
            work?</label><br>
        &nbsp;&nbsp; <input type="text" size="40" name="d[self_employed]" placeholder="Enter the Answer:" value="{{$student->data->d->self_employed ?? '' }}" disabled>
    </div>
    <br>
    ...
    <div>
        ...
        &nbsp;&nbsp; <input type="text" size="40"  name="d[present_occupation]" placeholder="Enter the Answer:" value="{{$student->data->d->present_occupation ?? '' }}" disabled>
    </div>
    ...
    <div class="container">
        ...
        <div>
            <table>
                ...
                <tr>
                    <td><input type="checkbox" name="d[opt1]" value="Salaries and benefits" {{ isset($student->data->d->opt1) ? 'checked' : '' }} disabled></td>
                    <td class="text-left">Salaries and benefits</td>
                </tr>

                <tr>
                    <td><input type="checkbox" name="d[opt2]" value="Career challenge" {{ isset($student->data->d->opt2) ? 'checked' : '' }} disabled></td>
                    <td class="text-left">Career challenge</td>
                </tr>

                <tr>
                    <td><input type="checkbox" name="d[opt3]" value="Related to special skill"  {{ isset($student->data->d->opt3) ? 'checked' : '' }} disabled></td>
                    <td class="text-left">Related to special skill</td>
                </tr>

                <tr>
                    <td><input type="checkbox" name="d[opt4]" value="Related to course or program of study"  {{ isset($student->data->d->opt4) ? 'checked' : '' }} disabled></td>
                    <td class="text-left">Related to course or program of study</td>
                </tr>


                <tr>
                    <td><input type="checkbox" name="d[opt5]" value="Proximity to residence"  {{ isset($student->data->d->opt5) ? 'checked' : '' }} disabled></td>
                    <td class="text-left">Proximity to residence</td>
                </tr>

                <tr>
                    <td><input type="checkbox" name="d[opt6]" value="Peer influence"  {{ isset($student->data->d->opt6) ? 'checked' : '' }} disabled></td>
                    <td class="text-left">Peer influence</td>
                </tr>

                <tr>
                    <td><input type="checkbox" name="d[opt7]" value="Family influence"  {{ isset($student->data->d->opt7) ? 'checked' : '' }} disabled></td>
    ...
    <table>
        ...
        <tr>
            <td><input type="checkbox" name="d[acceptjob1]" value="Salaries & benefits" {{ isset($student->data->d->acceptjob1) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Salaries & benefits</td>
        </tr>

        <tr>
            <td><input type="checkbox" name="d[acceptjob2]" value="Career challenge" {{ isset($student->data->d->acceptjob2) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Career challenge</td>
        </tr>

        <tr>
            <td><input type="checkbox" name="d[acceptjob3]" value="Related to special skills" {{ isset($student->data->d->acceptjob3) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Related to special skills</td>
        </tr>

        <tr>
            <td><input type="checkbox" name="d[acceptjob4]" value="Proximity to residence" {{ isset($student->data->d->acceptjob4) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Proximity to residence</td>
        </tr>

        <tr>
            <td><input type="checkbox" name="d[acceptjob5]" value="Other reason(s), please specify" {{ isset($student->data->d->acceptjob5) ? 'checked' : '' }} disabled></td>
    ...
    <table>
        ...
        <tr>
            <td><input type="checkbox" name="d[reason1]" value="Salaries & benefits" {{ isset($student->data->d->reason1) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Salaries & benefits</td>
        </tr>

        <tr>
            <td><input type="checkbox" name="d[reason2]" value="Career challenge" {{ isset($student->data->d->reason2) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Career challenge</td>
        </tr>

        <tr>
            <td><input type="checkbox" name="d[reason3]" value="Related to special skills" {{ isset($student->data->d->reason3) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Related to special skills</td>
        </tr>

        <tr>
            <td><input type="checkbox" name="d[reason4]" value="Proximity to residence" {{ isset($student->data->d->reason4) ? 'checked' : '' }} disabled></td>
            <td class="text-left">Proximity to residence</td>
        </tr>
    </table>
    <br>
...
<div class="" style="margin-left:">
    <div class="container">
        <table>
            ...
            <tr>
                <td><input type="checkbox" name="d[yes_useful_op1]" {{ isset($student->data->d->yes_useful_op1) ? 'checked' : '' }} disabled></td>
                <td class="text-left"> Communication skills</td>
            </tr>

            <tr>
                <td><input type="checkbox" name="d[yes_useful_op2]" {{ isset($student->data->d->yes_useful_op2) ? 'checked' : '' }} disabled></td>
                <td class="text-left"> Human Relations skills</td>
            </tr>

            <tr>
                <td><input type="checkbox" name="d[yes_useful_op3]" {{ isset($student->data->d->yes_useful_op3) ? 'checked' : '' }} disabled></td>
                <td class="text-left">Entrepreneurial skills</td>
            </tr>

            <tr>
                <td><input type="checkbox" name="d[yes_useful_op4]" {{ isset($student->data->d->yes_useful_op4) ? 'checked' : '' }} disabled></td>
                <td class="text-left">Information Technology skills</td>
            </tr>

            <tr>
                <td><input type="checkbox" name="d[yes_useful_op5]" {{ isset($student->data->d->yes_useful_op5) ? 'checked' : '' }} disabled></td>
                <td class="text-left">Problem-solving skills</td>
            </tr>

            <tr>
                <td><input type="checkbox" name="d[yes_useful_op6]" {{ isset($student->data->d->yes_useful_op6) ? 'checked' : '' }} disabled></td>
                <td class="text-left"> Critical Thinking skills</td>
            </tr>

            <tr>
                <td><input type="checkbox" name="d[yes_useful_op7]" {{ isset($student->data->d->yes_useful_op7) ? 'checked' : '' }} disabled></td>
        ...
        <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <input type="text" name="d[curriculum_suggestion]" placeholder="List down the suggestions.." size="50"
                                                         style="height: 70px;" value="{{$student->data->d->curriculum_suggestion ?? '' }}" disabled>
        </div>
        <br> <br>
        <table border="1">
            <h5>Thank you
