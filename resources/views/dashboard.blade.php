        ...
        <div class="row">
            ...
            <div class="col-lg-12" style="padding-top: 10px">
                ...
                <div class="col-lg-12 row">
                    <div class="col-lg-11">
                        <textarea type="text" class="input" placeholder="Write a comment" rows="5" id="description${post.id}"></textarea>
                    </div>
                    <div class="col-lg-1">
                        <button class='primaryContained mb-10 comment' style="width: 100%" data-id="${post.id}">
...
`
            ...
            function postComment(comments) {
                ...
                for (const comment of comments) {
                    display += `<div class="col-lg-12 mb-2 row">
                    ...
                    <div class="col-lg-9" style="border:gray 1px solid;1">
                            ${comment.description}
                    </div>
                </div>`
                }
